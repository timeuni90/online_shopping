...
public interface CommodityMapper {
    ...
    /* 按照关键字查找商品 */
    public List<Commodity> selectByKey(@Param("key")String key, @Param("sortType")Integer sortType, @Param("commodityCoverImageLocation")String commodityCoverImageLocation);
