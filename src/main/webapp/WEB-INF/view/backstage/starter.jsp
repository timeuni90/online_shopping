...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="${APP_PATH }/static/backstage/bower_components/font-awesome/css/font-awesome.min.css">
		<link rel="stylesheet" href="${APP_PATH }/static/backstage/bower_components/Ionicons/css/ionicons.min.css">
		<link rel="stylesheet" href="${APP_PATH }/static/backstage/dist/css/AdminLTE.min.css">
		<link rel="stylesheet" href="${APP_PATH }/static/backstage/dist/css/skins/skin-blue.min.css">
		
		<script src="${APP_PATH }/static/backstage/bower_components/jquery/dist/jquery.min.js"></script>
										...
										<ul class="menu">
											<li>
												...
												<a href="#">
													<div class="pull-left">
														<!-- User Image -->
														<img src="${APP_PATH }/static/backstage/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
													</div>
                        ...
                        <small class="pull-right">20%</small>
							...
							<li class="dropdown user user-menu">
								...
								<a href="#" class="dropdown-toggle" data-toggle="dropdown">
									...
									<img src="${APP_PATH }/static/backstage/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
