...
<header class="layout-header clearfix" id="layoutHeader">
	<div class="mzcontainer">
		...
		<ul class="layout-header-service clearfix">
			...
			<li class="layout-header-service-item layout-header-service-msg"
				id="layoutHeaderUser"><a class="layout-header-service-link"
				href="//me.meizu.com/member/index"
				data-mtype="wmz_public_yt_mycenter"
				data-bh="click_wmz_public_yt_mycenter"> <img
					src="//image-res.mzres.com/img/download/uc/15/19/10/12/30/151910123/w200h200?t=1517740541000"
			...
			<li class="layout-header-service-item layout-header-service-cart"
				...
				data-bh="click_wmz_public_yt_cart"> <img
					...
					class="layout-header-service-cart-num" style="line-height: 15px;">1</span>
			</a></li>
		</ul>
